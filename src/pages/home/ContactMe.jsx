    ...
    return (
        <Form noValidate validated={validated} onSubmit={handleSubmit} id="contact-form">
            ...
            <Form.Group className="pt-2" controlId="exampleForm.ControlTextarea1">
                ...
                <Form.Control className="contact-form-textarea" as="textarea" name="message" rows={3} required/>
                <Form.Control.Feedback type='invalid' className='text-white text-end'>Please fill out this field!</Form.Control.Feedback>
            </Form.Group>
            <button id='submit-form-btn' className='btn rounded text-white' type='submit'>Submit</button>
        </Form>
    )
}
